...
if (bitrate_i == 4) {quality = 320} else {quality = 160;}
    ...
    results_objects[song_id] = {
      ...
      results.push(`
      <div class="text-left song-container" style="margin-bottom:10px;border-radius:10px;padding:10px;background: linear-gradient(to top left, #33ccff 0%, #ff99cc 100%);">
      <div class="row" style="margin:0">
          ...
          <div class="col" style="border-style:none;padding:2px;">
              <p class="float-right fit-content" style="margin:20px;color:#fff;padding-right:100px;">${year}</p>
              ...
              <p class="float-right fit-content" style="margin:20px;color:#fff;padding-right:100px;padding-top:10px;">${play_time}<br/></p>
          </div>
      </div>
  </div>
`
