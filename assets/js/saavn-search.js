    ...
    results_objects[song_id] = {
      ...
      <div class="row" style="margin:0">
          ...
          <div class="col" style="border-style:none;padding:2px; background: linear-gradient(to top left, #33ccff 0%, #ff99cc 100%);">
              <p class="float-right fit-content" style="margin:0px;color:#fff;padding-right:20px;">${year}</p>
              ...
              <button class="btn btn-primary song-btn" type="button" style="margin:0px 35px;" onclick='PlayAudio("${download_url}","${song_id}")'>▶️</button>
              <button class="btn btn-primary song-btn" type="button" style="margin:0px 35px;" onclick='AddDownload("${song_id}")'>📤</button>
