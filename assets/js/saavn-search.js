    ...
    results_objects[song_id] = {
      ...
      <div class="row" style="margin:0">
          ...
          <div class="col" style="border-style:none;padding:2px;">
              <p class="float-right fit-content" style="margin:0px;color:#fff;padding-right:50px;">${year}</p>
              ...
              <p class="float-right fit-content" style="margin:0px;color:#fff;padding-right:50px;padding-top:5px;">${play_time}<br/></p>
          </div>
      </div>
  </div>
`
