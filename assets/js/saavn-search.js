...
if (bitrate_i == 4) {quality = 320} else {quality = 160;}
    ...
    results_objects[song_id] = {
      ...
      results.push(`
      <div class="text-left song-container" style="margin-bottom:20px;border-radius:10px;background:linear-gradient(to top left, #33ccff 0%, #ff99cc 100%);padding:5px;">
      <div class="row" style="margin:auto;">
          ...
          <div class="col" style="border-style:none;padding:2px;">
              ...
              <button class="btn btn-primary song-btn" type="button" style="margin:0px 5px;" onclick='AddDownload("${song_id}")'>DL</button>
              <p class="float-right fit-content" style="margin:0px;color:linear-gradient(to top left, #33ccff 0%, #ff99cc 100%);padding-right:10px;padding-top:15px;">${play_time}<br/></p>
          </div>
      </div>
  </div>
`
