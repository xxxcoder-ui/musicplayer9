...
if (bitrate_i == 4) {quality = 320} else {quality = 160;}
    ...
    results_objects[song_id] = {
      ...
      results.push(`
      <div class="text-left song-container" style="margin-bottom:5px;border-radius:10px;padding:5px;background: linear-gradient(to top left, #33ccff 0%, #ff99cc 100%);">
      <div class="row" style="margin:0">
          <div class="col-auto" style="padding:10px;padding-right:10px;border-style:none;">
          ...
          <div class="col" style="border-style:none;padding:5px;">
              <p class="float-right fit-content" style="margin:0px;color:#fff;padding-right:5px;background: linear-gradient(to top left, #33ccff 0%, #ff99cc 100%);">${year}</p>
              ...
              <p class="float-right fit-content" style="margin:0px;color:#fff;padding-right:5px;padding-top:5px;background: linear-gradient(to top left, #33ccff 0%, #ff99cc 100%);">${play_time}<br/></p>
          </div>
      </div>
  </div>
`
