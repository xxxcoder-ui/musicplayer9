    ...
    results_objects[song_id] = {
      ...
      <div class="row" style="margin:0">
          ...
          <div class="col" style="border-style:none;padding:2px; background: linear-gradient(to top left, #33ccff 0%, #ff99cc 100%);">
              <p class="float-right fit-content" style="margin:0px;color:#fff;padding-right:30px;">${year}</p>
              ...
              <p class="float-right fit-content" style="margin:0px;color:linear-gradient(to top left, #33ccff 0%, #ff99cc 100%);padding-right:30px;padding-top:10px;">${play_time}<br/></p>
          </div>
      </div>
  </div>
`
